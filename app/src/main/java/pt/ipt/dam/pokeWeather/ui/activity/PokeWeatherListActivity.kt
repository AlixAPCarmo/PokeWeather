...
import pt.ipt.dam.pokeWeather.model.Weather
...
class PokeWeatherListActivity : AppCompatActivity(), LocationListener {
    ...
    // Add this function within your PokeWeatherListActivity class
    ...
    fun getWeatherImage(id: String) {
        ...
        executor.execute {
            ...
            try {
                ...
                handler.post {
                    Toast.makeText(this@PokeWeatherListActivity, "Failed to load image.", Toast.LENGTH_SHORT).show()
                }
